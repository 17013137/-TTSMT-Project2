#include "..\Public\VIBuffer_Barricade2.h"



CVIBuffer_Barricade2::CVIBuffer_Barricade2(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CVIBuffer(pGraphic_Device)
{
}

CVIBuffer_Barricade2::CVIBuffer_Barricade2(const CVIBuffer_Barricade2 & rhs)
	:CVIBuffer(rhs)
{
}

HRESULT CVIBuffer_Barricade2::NativeConstruct_Prototype()
{
	...
	pVertices[0].vColor = 0xff272221;

	pVertices[1].vPosition = _float3(-0.4f, 1.f, 0.4f);
	pVertices[1].vColor = 0xff272221;

	pVertices[2].vPosition = _float3(0.f, 0.f, -0.5f);
	pVertices[2].vColor = 0xff272221;

	pVertices[3].vPosition = _float3(-0.1f, 0.f, -0.5f);
	pVertices[3].vColor = 0xff272221;

	pVertices[4].vPosition = _float3(-0.5f, 1.f, 0.5f);
	pVertices[4].vColor = 0xff272221;

	pVertices[5].vPosition = _float3(-0.4f, 1.f, 0.5f);
	pVertices[5].vColor = 0xff272221;

	pVertices[6].vPosition = _float3(0.f, 0.f, -0.4f);
	pVertices[6].vColor = 0xff272221;

	pVertices[7].vPosition = _float3(-0.1f, 0.f, -0.4f);
	pVertices[7].vColor = 0xff272221;

	//2번가시
	pVertices[8].vPosition = _float3(0.f, 1.f, -0.5f);
	pVertices[8].vColor = 0xff272221;

	pVertices[9].vPosition = _float3(0.1f, 1.f, -0.5f);
	pVertices[9].vColor = 0xff272221;
	pVertices[10].vPosition = _float3(0.5f, 0.f, 0.4f);
	pVertices[10].vColor = 0xff272221;

	pVertices[11].vPosition = _float3(0.4f, 0.f, 0.4f);
	pVertices[11].vColor = 0xff272221;

	pVertices[12].vPosition = _float3(0.f, 1.f, -0.4f);
	pVertices[12].vColor = 0xff272221;

	pVertices[13].vPosition = _float3(0.1f, 1.f, -0.4f);
	pVertices[13].vColor = 0xff272221;

	pVertices[14].vPosition = _float3(0.5f, 0.f, 0.5f);
	pVertices[14].vColor = 0xff272221;

	pVertices[15].vPosition = _float3(0.4f, 0.f, 0.5f);
	pVertices[15].vColor = 0xff272221;



	//3번가시
	pVertices[16].vPosition = _float3(-0.1f, 1.f, -0.5f);
	pVertices[16].vColor = 0xff7a7a7a;

	pVertices[17].vPosition = _float3(0.f, 1.f, -0.5f);
	pVertices[17].vColor = 0xff7a7a7a;

	pVertices[18].vPosition = _float3(-0.4f, 0.f, 0.4f);
	pVertices[18].vColor = 0xff7a7a7a;

	pVertices[19].vPosition = _float3(-0.5f, 0.f, 0.4f);
	pVertices[19].vColor = 0xff7a7a7a;

	pVertices[20].vPosition = _float3(-0.1f, 1.f, -0.4f);
	pVertices[20].vColor = 0xff7a7a7a;

	pVertices[21].vPosition = _float3(0.f, 1.f, -0.4f);
	pVertices[21].vColor = 0xff7a7a7a;

	pVertices[22].vPosition = _float3(-0.4f, 0.f, 0.5f);
	pVertices[22].vColor = 0xff7a7a7a;

	pVertices[23].vPosition = _float3(-0.5f, 0.f, 0.5f);
	pVertices[23].vColor = 0xff7a7a7a;



	//4번가시
	pVertices[24].vPosition = _float3(0.4f, 1.f, 0.4f);
	pVertices[24].vColor = 0xff7a7a7a;

	pVertices[25].vPosition = _float3(0.5f, 1.f, 0.4f);
	pVertices[25].vColor = 0xff7a7a7a;

	pVertices[26].vPosition = _float3(0.1f, 0.f, -0.5f);
	pVertices[26].vColor = 0xff7a7a7a; 

	pVertices[27].vPosition = _float3(0.f, 0.f, -0.5f);
	pVertices[27].vColor = 0xff7a7a7a;

	pVertices[28].vPosition = _float3(0.4f, 1.f, 0.5f);
	pVertices[28].vColor = 0xff7a7a7a;

	pVertices[29].vPosition = _float3(0.5f, 1.f, 0.5f);
	pVertices[29].vColor = 0xff7a7a7a;

	pVertices[30].vPosition = _float3(0.1f, 0.f, -0.4f);
	pVertices[30].vColor = 0xff7a7a7a;

	pVertices[31].vPosition = _float3(0.f, 0.f, -0.4f);
	pVertices[31].vColor = 0xff7a7a7a;



	//5번가시
	pVertices[32].vPosition = _float3(-0.25f, 0.55f, 0.f);
	pVertices[32].vColor = 0xff1e1e1e;

	pVertices[33].vPosition = _float3(0.25f, 0.55f, 0.f);
	pVertices[33].vColor = 0xff1e1e1e;

	pVertices[34].vPosition = _float3(0.25f, 0.5f, -0.05f);
	pVertices[34].vColor = 0xff1e1e1e;

	pVertices[35].vPosition = _float3(-0.25f, 0.5f, -0.05f);
	pVertices[35].vColor = 0xff1e1e1e;

	pVertices[36].vPosition = _float3(-0.25f, 0.5f, 0.05f);
	pVertices[36].vColor = 0xff1e1e1e;

	pVertices[37].vPosition = _float3(0.25f, 0.5f, 0.05f);
	pVertices[37].vColor = 0xff1e1e1e;

	pVertices[38].vPosition = _float3(0.25f, 0.45f, 0.f);
	pVertices[38].vColor = 0xff1e1e1e;

	pVertices[39].vPosition = _float3(-0.25f, 0.45f, -0.f);
	pVertices[39].vColor = 0xff1e1e1e;
...
HRESULT CVIBuffer_Barricade2::NativeConstruct(void * pArg)
{
...
CVIBuffer_Barricade2 * CVIBuffer_Barricade2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CVIBuffer_Barricade2*	pInstance = new CVIBuffer_Barricade2(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_Barricade2"));
...
CComponent * CVIBuffer_Barricade2::Clone(void * pArg)
{
	CVIBuffer_Barricade2*	pInstance = new CVIBuffer_Barricade2(*this);
...
void CVIBuffer_Barricade2::Free()
{
	__super::Free();
}
