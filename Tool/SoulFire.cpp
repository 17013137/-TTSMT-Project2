...
void CSoulFire::Tick(_float fTimeDelta)
{
...
_bool CSoulFire::Picking(_float3 * _pickpos)
{
	_float3	vOut;
...
HRESULT CSoulFire::SetUp_Components()
{
	...
	if (FAILED(__super::SetUp_Components(TEXT("Com_VIBuffer"), STAGE_SCENE, TEXT("Prototype_Component_VIBuffer_Rect"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
	if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), STAGE_SCENE, TEXT("Prototype_Component_Texture_SoulFire"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
