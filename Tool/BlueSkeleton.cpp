...
CBlueSkeleton::CBlueSkeleton(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CBlueSkeleton::CBlueSkeleton(const CBlueSkeleton & rhs)
	: CGameObject(rhs)

{
}

HRESULT CBlueSkeleton::NativeConstruct_Prototype()
{
...
HRESULT CBlueSkeleton::NativeConstruct(void * pArg)
{
...
void CBlueSkeleton::Tick(_float fTimeDelta)
{
...
void CBlueSkeleton::LateTick(_float fTimeDelta)
{
...
HRESULT CBlueSkeleton::Render()
{
	...
	for (int i = 0; i < 9; ++i)
	{
		...
		if (FAILED(m_vTT[i]->Bind_OnGraphicDevice(5)))
			return E_FAIL;
...
_bool CBlueSkeleton::Picking(_float3 * _pickpos)
{
	_float3	vOut;
...
HRESULT CBlueSkeleton::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CBlueSkeleton::SetUp_OnTerrain()
{
...
void CBlueSkeleton::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CBlueSkeleton::Set_Part2(int Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CBlueSkeleton::Attack(_float fTimeDelta)
{
...
void CBlueSkeleton::find(_float fTimeDelta)
{
...
void CBlueSkeleton::Crawl(_float fTimeDelta)
{
	//움직이는 속도
...
void CBlueSkeleton::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CBlueSkeleton::Move(_float fTimeDelta)
{
	//움직이는 속도
	_float3 RH = _float3(-0.0015f, 0.01f, 0.01f);
	_float3 LH = _float3(0.0015f, 0.01f, 0.01f);
...
void CBlueSkeleton::Stay(_float fTimeDelta)
{
...
CBlueSkeleton * CBlueSkeleton::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBlueSkeleton*	pInstance = new CBlueSkeleton(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to First Created CBlueSkeleton"));
...
CGameObject * CBlueSkeleton::Clone(void * pArg)
{
	CBlueSkeleton*	pInstance = new CBlueSkeleton(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX(TEXT("Failed to Clone Created CBlueSkeleton"));
		Safe_Release(pInstance);
	}
