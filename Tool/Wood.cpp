...
HRESULT CWood::NativeConstruct_Prototype()
{
...
HRESULT CWood::NativeConstruct(void * pArg)
{
...
HRESULT CWood::Render()
{
	...
	if (FAILED(m_pTextureCom->Bind_OnGraphicDevice(17)))
		return E_FAIL;
...
_bool CWood::Picking(_float3 * _pickpos)
{
	_float3	vOut;
