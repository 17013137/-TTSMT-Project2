...
HRESULT CDoor::SetUp_Components()
{
	...
	if (FAILED(__super::SetUp_Components(TEXT("Com_VIBuffer"), STAGE_SCENE, TEXT("Prototype_Component_VIBuffer_Door"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;

	return S_OK;
}

_bool CDoor::Picking(_float3 * _pickpos)
{
	_float3	vOut;
