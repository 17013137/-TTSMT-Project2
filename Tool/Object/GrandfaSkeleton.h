...
class CGrandfaSkeleton final : public CGameObject
{
public:
	enum STATE { STATE_STAY, STATE_WALK, STATE_RUN, STATE_FIND, STATE_MOVE, STATE_ATTACK, STATE_END };
private:
	explicit CGrandfaSkeleton(LPDIRECT3DDEVICE9 pGraphic_Device);
	CGrandfaSkeleton(const CGrandfaSkeleton& rhs);
	virtual ~CGrandfaSkeleton() = default;
...
public:
	static CGrandfaSkeleton* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
