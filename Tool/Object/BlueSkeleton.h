...
class CBlueSkeleton final : public CGameObject
{
public:
	enum STATE { STATE_STAY, STATE_WALK, STATE_RUN, STATE_FIND, STATE_MOVE, STATE_ATTACK, STATE_END };
private:
	explicit CBlueSkeleton(LPDIRECT3DDEVICE9 pGraphic_Device);
	CBlueSkeleton(const CBlueSkeleton& rhs);
	virtual ~CBlueSkeleton() = default;
...
public:
	static CBlueSkeleton* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
