...
HRESULT CTree::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::SetUp_Components(TEXT("Com_VIBuffer"), STAGE_SCENE, TEXT("Prototype_Component_VIBuffer_Tree"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;

	return S_OK;
}

_bool CTree::Picking(_float3 * _pickpos)
{
	_float3	vOut;
