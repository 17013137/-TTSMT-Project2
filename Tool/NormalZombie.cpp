...
CNormalZombie::CNormalZombie(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CNormalZombie::CNormalZombie(const CNormalZombie & rhs)
	: CGameObject(rhs)

{
}

HRESULT CNormalZombie::NativeConstruct_Prototype()
{
...
HRESULT CNormalZombie::NativeConstruct(void * pArg)
{
...
void CNormalZombie::Tick(_float fTimeDelta)
{
...
void CNormalZombie::LateTick(_float fTimeDelta)
{
...
HRESULT CNormalZombie::Render()
{
	...
	for (int i = 0; i < 9; ++i)
	{
		...
		if (FAILED(m_vTT[i]->Bind_OnGraphicDevice(0)))
			return E_FAIL;
...
_bool CNormalZombie::Picking(_float3 * _pickpos)
{
	_float3	vOut;
...
HRESULT CNormalZombie::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CNormalZombie::SetUp_OnTerrain()
{
...
void CNormalZombie::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CNormalZombie::Set_Part2(int Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CNormalZombie::Attack(_float fTimeDelta)
{
...
void CNormalZombie::find(_float fTimeDelta)
{
...
void CNormalZombie::Crawl(_float fTimeDelta)
{
	//움직이는 속도
...
void CNormalZombie::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CNormalZombie::Move(_float fTimeDelta)
{
	//움직이는 속도
	_float3 RH = _float3(-0.0015f, 0.01f, 0.01f);
	_float3 LH = _float3(0.0015f, 0.01f, 0.01f);
...
void CNormalZombie::Stay(_float fTimeDelta)
{
...
CNormalZombie * CNormalZombie::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CNormalZombie*	pInstance = new CNormalZombie(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to First Created CNormalZombie"));
...
CGameObject * CNormalZombie::Clone(void * pArg)
{
	CNormalZombie*	pInstance = new CNormalZombie(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX(TEXT("Failed to Clone Created CNormalZombie"));
		Safe_Release(pInstance);
	}
