...
void CCone::Tick(_float fTimeDelta)
{
...
HRESULT CCone::SetUp_Components()
{
	...
	if (FAILED(__super::SetUp_Components(TEXT("Com_VIBuffer"), STAGE_SCENE, TEXT("Prototype_Component_VIBuffer_Cone"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;

	return S_OK;
}

_bool CCone::Picking(_float3 * _pickpos)
{
	_float3	vOut;
